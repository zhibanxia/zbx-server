  ...
  <div id="detail-container">
    ...
    <div class="detail-content">
      ...
      <van-cell-group>
        ...
        <!-- icon="goods-collect" -->
        <van-cell title="是否帮忙带扔垃圾"  :value="data.takeGarbage ? '是' : '否'"/>
        <!-- icon="pending-deliver" -->
        <van-cell v-if="data.doorServStartTime && data.doorServEndTime" title="上门服务时间段"  :value="data.doorServStartTime + '~' + data.doorServEndTime"/>
        <!-- icon="pending-deliver" -->
        ...
        <van-cell title="回收时间" v-if="data.recyleTime" icon="pending-deliver" :value="data.recyleTime"/>
        <van-cell title="备注" icon="description" :value="data.resNote"/>
      </van-cell-group>
    </div>
    <!-- 按钮区域 TODO -->
